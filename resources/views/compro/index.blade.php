        ...
        <section class="resume-section" id="about">
            <div class="resume-section-content">
                ...
                <div class="subheading mb-5">
                    {{ $profile->alamat }} · (+62) {{ $profile->no_telepon }} ·
                    <a href="mailto:{{ $profile->email }}">{{ $profile->email }}</a>
                </div>
                <p class="lead mb-5">{{ $profile->deskripsi }}</p>
                <div class="social-icons">
                    <a class="social-icon" href="{{ $profile->linkedin }}"><i class="fab fa-linkedin"></i></a>
                    ...
                    <a class="social-icon" href="{{ $profile->facebook }}"><i class="fab fa-facebook"></i></a>
                </div>
            </div>
        </section>
        <hr class="m-0" />
                ...
                @foreach ($experience as $item)
                    <div class="d-flex flex-column flex-md-row justify-content-between mb-5">
                        <div class="flex-grow-1">
                            ...
                            <div class="subheading mb-3">{{ $item->subjudul }}</div>
                            <p>{{ $item->deskripsi }}</p>
                        </div>
                        <div class="flex-shrink-0"><span class="text-primary">{{ $item->tgl_experience }}</span></div>
                    </div>
                @endforeach
            </div>
        </section>
